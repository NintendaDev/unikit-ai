...
rule and the self-heal-vs-conflict distinction apply exactly as in the SKILL's Phase 2.
The **cross-axis impact** of a system edit on dependent flows / content types lives in
the SKILL's Phase 3, not here.
