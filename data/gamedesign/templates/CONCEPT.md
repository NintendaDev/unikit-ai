...
> **Status**: exploring | drafted | approved
> **Version**: 1
> **Created**: [YYYY-MM-DD]
...
| # | Field | Value |
|---|-------|-------|
| 1 | **Elevator pitch** | [One sentence: "A *[genre]* where you *[core verb]* in a *[setting]* to *[goal]*." Understandable by a stranger in 10 seconds.] |
| 2 | **Core fantasy** | [The emotional promise — what the player gets to *be* or *do* here that they cannot elsewhere.] |
| 3 | **Unique hook** | [The single differentiator. Passes the "and also" test: "like *[comparable]*, AND ALSO *[novel thing that changes play, not just art]*".] |
| 4 | **Primary aesthetics (MDA)** | [Top 2–3 of: Sensation, Fantasy, Narrative, Challenge, Fellowship, Discovery, Expression, Submission.] |
