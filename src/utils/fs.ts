...
export function getBundledRegistryDir(): string {
  return path.join(getPackageRoot(), 'rules-registry');
}
...
export function getEngineTemplatesDir(): string {
  return path.join(getDataDir(), 'engine-templates');
}
